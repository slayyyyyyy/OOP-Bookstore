...
Angajat::Angajat(std::string nume_, int id_angajat_, float salariu_, int perioada_, int varsta_) : nume{std::move(nume_)}, id_angajat{id_angajat_}, salariu{salariu_}, perioada{perioada_}, varsta{varsta_}
